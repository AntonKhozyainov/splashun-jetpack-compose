...
import ru.khozyainov.splashun.utils.MarqueeAnimationMode.Companion.Immediately
import ru.khozyainov.splashun.utils.MarqueeAnimationMode.Companion.WhileFocused
...
fun Modifier.basicMarquee(
    ...
    val modifier = remember(
        ...
        MarqueeModifier(
            ...
            velocity = velocity * if (layoutDirection == LayoutDirection.Ltr) 1f else -1f,
            spacing = spacing,
